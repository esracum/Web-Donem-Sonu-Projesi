        ...
        <div class="col-8 ">
            ...
            <div class="row bg-white">
                    ...
                    <div id="carouselExampleControls" class="carousel slide my-2" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/bilek1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item active">
                                <img src="img/bilek2.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item active">
                                <img src="img/bilek3.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item active">
                                <img src="img/bilek4.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item active">
                                <img src="img/bilek5.jpg" class="d-block w-100" alt="...">
                            </div>
                            
                            
                            <div class="carousel-item">
                                <img src="img/kolye1" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/kolye2" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/kolye3" class="d-block w-100" alt="...">
                            </div>
                           
                            
                            <div class="carousel-item">
                                <img src="img/yuzuk1" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/yuzuk2" class="d-block w-100" alt="...">
                            </div>
                            
                            
      
                            <div class="carousel-item">
                                <img src="img/kupe1" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/kupe2" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/kupe3" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/kupe4" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="img/kupe5" class="d-block w-100" alt="...">
                            </div>
                ...
                <div class="col-7">
                    ...
                    <div class="row text-secondary mt-2 px-3"> <p>urun cok detayli</p> </div>
