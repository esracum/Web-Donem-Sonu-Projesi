...
%>
        ...
        <div class="alert alert-secondary " style="margin-top: 20px; background-color: #FFB6C1;" role="alert">
            <h4 id="list-item-5" class="ml-4 ">Yoneticiler</h4>
        </div>
        <hr>
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-secondary ml-4 my-2" style="margin-top: 20px; background-color: #6a5acd;data-toggle="modal" data-target="#exampleModalLong45">
            Yonetici Ekle
        </button>
                        ...
                        <%
                        			for(yoneticiModel yonetici:yoneticilerr){
                        				...
                        				<tr>
                            					...
                            					<td>
    <button type="button" class="btn btn-secondary" style="margin-top: 20px; background-color: #ed5ecd; margin-right: 10px;" data-toggle="modal" data-target="#exampleModalLong">
        Guncelle
    </button>
    <a href="yoneticiSil.jsp?<%=yonetici.getKullaniciAdi()%>">
        <button type="button" class="btn btn-secondary" style="margin-top: 20px; background-color: #ed5ecd;">
            Sil
        </button>
    </a>
</td>
