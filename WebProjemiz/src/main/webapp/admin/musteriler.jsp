...
<div class="alert alert-secondary " style="margin-top: 20px; background-color: #FFB6C1;" role="alert">
        ...
        <button type="button" class="btn btn-secondary ml-4 my-2"style="margin-top: 20px; background-color: #6a5acd; data-toggle="modal" data-target="#exampleModalLong">
            Musteri Ekle
        </button>
                ...
                <table class="table table-hover px-5">
                    ...
                    <tbody>
                        <%
                            ...
                            <a href="musteriSil.jsp?<%=musteri.getKullaniciAdi()%>">
